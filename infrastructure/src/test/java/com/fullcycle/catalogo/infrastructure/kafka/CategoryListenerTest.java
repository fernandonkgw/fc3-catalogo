...
class CategoryListenerTest extends AbstractEmbeddedKafkaTest {
    ...
    void givenInvalidResponsesFromHandlerShouldRetryUntilGoesToDLT() throws Exception {
        ...
        final var latch = new CountDownLatch(5); // mecanismo para testar processamento async do kafka
    ...
    void givenUpdateOperationWhenProcessGoesOKShouldEndTheOperation() throws Exception {
        ...
        final var latch = new CountDownLatch(1); // mecanismo para testar processamento async do kafka
