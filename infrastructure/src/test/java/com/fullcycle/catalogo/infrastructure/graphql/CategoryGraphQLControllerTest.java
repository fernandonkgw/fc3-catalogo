...
class CategoryGraphQLControllerTest {
    ...
    @Test
    void givenDefaultArgumentsWhenCallsListCategoriesShouldReturn() {
        // given
    ...
    @Test
    void givenCustomArgumentsWhenCallsListCategoriesShouldReturn() {
        // given
        final var expectedCategories = List.of(
                ListCategoryOutput.from(Fixture.Categories.lives()),
                ListCategoryOutput.from(Fixture.Categories.aulas())
    ...
    @Test
    void givenCategoryInputWhenCallsSaveCategoryMutationShouldPersistAndReturn() {
        // given
        ...
        final var query = """
                ...
                """;
        doAnswer(returnsFirstArg()).when(this.saveCategoryUseCase).execute(any());
        // when
        ...
        verify(this.saveCategoryUseCase, times(1)).execute(captor.capture());
